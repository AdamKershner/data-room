...
function TeamExecution() {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      q1Goals: {
        overview: "Support NPS increase through design system and UI/UX improvements",
        target: "Complete 10+ design mockups, update design system, and design 5+ user flows to support +15 NPS",
        weeklyBreakdown: [
          { week: 1, goal: "Complete design system documentation", metric: "Design system ready" },
          { week: 2, goal: "Week 2: Design mockups for top improvements", metric: "1+ mockup completed" },
          { week: 3, goal: "Week 3: Design mockups for top improvements", metric: "1+ mockup completed" },
          ...
          { week: 6, goal: "Week 6: Design mockups for top improvements", metric: "1+ mockup completed" },
          ...
          { week: 9, goal: "Week 9: Design mockups for top improvements", metric: "1+ mockup completed" },
          ...
          { week: 12, goal: "Week 12: Design mockups for top improvements", metric: "1+ mockup completed" },
          { week: 13, goal: "Q1 design review", metric: "10+ mockups, 5+ user flows, design system updated" }
        ],
        keyMetrics: [
      ...
      projects: [
        {
          ...
          status: "active",
          startDate: "January 2026",
          description: "Create and maintain design system for consistent UI/UX across Oasis Browser.",
          scope: [
            "Design component library and style guide",
            "Create design mockups for new features",
            "Ensure consistent design language across product",
            "Collaborate with engineering on design implementation"
          ],
          goals: [
            "Complete design system documentation",
            "Create design mockups for 5+ new features",
