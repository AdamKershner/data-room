...
function OasisSprintsArchive() {
  ...
  return (
    <div className="page" id="product-roadmap">
      <ArchiveBanner />
      <div className="sprints-linear-banner" role="status" style={{ marginBottom: 16 }}>
        <p>
          <strong>Historical archive.</strong> Active engineering backlog now lives in{' '}
...
export default OasisSprintsArchive
