...
const TEMPLATE_MESSAGES = {
  ...
  shortOverview:
    "We're launching Aura Library (https://about.kahana.io) on Product Hunt soon. Going for #1—need 350 upvotes on launch day. Takes <5 min to help and would mean a lot. Say Yes and I'll send instructions.",
  shortInstructions:
  ...
  groupAsk:
    "Hey everyone—quick favor? We're launching Aura Library (https://about.kahana.io) on Product Hunt soon. Going for #1—need 350 upvotes on launch day. If you're willing to help (takes <5 min), reply here and I'll send instructions. Would mean a lot!",
  groupInstructions:
        ...
        <div className="producthunt-chat">
          ...
          <div className="producthunt-chat-row producthunt-chat-you-row">
            <div className="producthunt-chat-bubble producthunt-chat-you">
              ...
              <p>
                We&apos;ve been building Aura Library (
                <a href="https://about.kahana.io/" target="_blank" rel="noopener noreferrer" className="producthunt-link">
                  about.kahana.io
                </a>
          ...
          <div className="producthunt-chat">
            <div className="producthunt-chat-row producthunt-chat-you-row">
              <div className="producthunt-chat-bubble producthunt-chat-you">
                ...
                <p>
                  Hey everyone—quick favor? We&apos;re launching Aura Library (
                  <a href="https://about.kahana.io/" target="_blank" rel="noopener noreferrer" className="producthunt-link">
                    about.kahana.io
                  </a>
