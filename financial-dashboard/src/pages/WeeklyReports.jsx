  ...
  const [reports] = useState([
    {
      ...
      keyUpdates: [
        ...
        'Customer success & launch readiness: Agrima Gupta, Rashmila Mitra, Samyak Jain, and Rohith CMR are working on the post-launch 0–90 day action plan for how we deliver customer support and success to new users who join from the Product Hunt launch.',
        'Praveen and Pallavi are researching DNS rebinding (aligned with recent enterprise prospect feedback) and will produce an internal report plus new blog content on the topic.',
        'Aishwarya Shetiya is developing a plan for a “Virtual Events Practice” to nurture and educate the MQLs and B2B prospects the team is identifying.',
        'Engineering (Ashwin John): Sprint merge work — merging in progress: (1) onboarding (including OAuth options), (2) Command_Type and User_Intent classification, (3) improved voice-to-text UI and responsiveness. Next up after this merge: (1) semantic search history, (2) daily token usage limits.',
        <>Engineering: Windows automatic software updates — in progress. Pipeline: (1) security testing (PM: Archana Ramalingam), (2) new features evaluation against the browser automation landscape — see <a href="https://mcpmarket.com/categories/browser-automation" target="_blank" rel="noopener noreferrer">MCP Market — browser automation</a>.</>,
        'Engineering: Archit Gupta and Revanth are working on Sprint 25 to implement daily token usage limits for Oasis.',
        'Compliance: Hasitha Sigatapu is making steady progress on the SOC 2 Type 1 project and will soon onboard Pruthvi to help with it.',
        'Security program: Archana Ramalingam is translating Ruturaj Marathe’s security testing plan into a checklist with tasks that the team will use to execute testing.',
        'GTM: Yaseer met with an enterprise solutions architect from Red Hat.',
        'Engineering: Rushyanth Nerellakunta is expanding the voice-to-text and conversational experience of Oasis.',
        'Engineering: Likhitha Guggilla is finishing Sprint 11 (semantic search history). Preethi B K will soon join that sprint to help with testing and expanding the feature set (Preethi also logged internship onboarding, 3 hours on April 3).',
        'Engineering: Atharva Joshi and Ruturaj Marathe are working on Sprint 15 — setting up the automatic software updates pipeline for Windows.',
        'Adam Kershner submitted the Arch Grants application ($75K non-dilutive) with Pournami Pottekat on the pitch deck and Ammemah Naeem’s review. He also sent about 40 LinkedIn connection requests to potential seed investors and took calls to pitch select investment banks.',
        'Prospecting shout-out: Mukesh Basvekar, Saksham Mehta, Hasan Bohra, Ravi chandra Dasari, Samyak Jain, Aishwarya Shetiya, Rohan Mehere, Akansha Parihar, Hritik Sanjay Chalse, BD Manikandan, Navile Mahesh, Yaseer, Rohith CMR, and Abhinav Chandra added more B2B prospects (enterprise solutions architects) to the Google Sheet.',
    ...
    },
    {
      ...
      keyUpdates: [
        ...
        <>Rashmila: Shared updates with the PMM team on building Mixpanel dashboards for conversion and drop‑off funnels, current data discrepancies (7 vs 30 days), blockers and need to verify event definitions before expanding dashboards. Also shared end‑to‑end marketing funnel (B2C to B2B expansion), for tracking business users and referral sources in Mixpanel to link good users to effective marketing channels and measure ROI on content and time. Also discussed focus areas on blogging, video editing, and animations to boost content output. See the <a href="https://docs.google.com/document/d/1xTYWL9chXtI7ep8BBTz1Z_z50kdRcFVfFr8uPGWnblM/edit?tab=t.0" target="_blank" rel="noopener noreferrer">charter</a> for the GTM Mixpanel Boards &amp; Reports project (due March 4th).</>,
