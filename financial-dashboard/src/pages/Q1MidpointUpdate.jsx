...
const FAQ_ITEMS = [
  ...
  { category: 'Learning & iteration', question: 'What would make Q1 a clear success vs. "we tried a lot of things"?', answer: <><p><strong>Clear success</strong> = hitting defined outcomes, not just activity:</p><ul><li><strong>B2C:</strong> 15+ paying customers (ideally 40, as targeted at the start of Q1); NPS over 30; knowing where our paid users originate from (attribution); Sprint 15 (automatic software updates) complete.</li><li><strong>B2B:</strong> Enterprise product demo-ready; 3 signed LOIs.</li><li><strong>Investor:</strong> Verbal commitments from investors in the database that our LOI format and traction are acceptable for Seed.</li><li><strong>Operations:</strong> SOC 2 in progress, website updated; ownership assigned (Adam for Culture Amp, Sprint 17 for delivery).</li></ul><p>We can hit our goals if we work together and believe in each other.</p><p><strong>&quot;We tried a lot of things&quot;</strong> = scattered activity without these outcomes—many demos, content, and experiments but no LOIs, no clear path to 15+ paying users, no investor alignment on LOI format.</p></> },
]
