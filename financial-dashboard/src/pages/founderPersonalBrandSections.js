...
export const PROVEN_MODEL_CONTENT = {
  ...
  story: [
    ...
    'I pull up Instagram and look up John Summit, and sure enough, I realize I do kind of look like him. Then I started listening to his music and actually really liked it. I became a fan.',
  ...
  parallels: [
    ...
    {
      label: 'Rejections, then grind',
      johnSummit: 'Hundreds of label nos before festivals and arenas',
      adam: 'Plenty of investor rejections and nos; kept building product and brand',
    },
    {
      label: 'Rise velocity',
