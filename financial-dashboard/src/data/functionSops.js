    ...
    sections: [
      {
        ...
        steps: [
          ...
          {
            id: 'pre-mood-board',
            label: 'Pull headline, subheadline, and CTA from the Mood Board',
            doneWhen: 'Pull headline, subheadline, and CTA from the Mood Board. Do not invent a competing Product Hunt slogan.',
            text: 'Pull headline, subheadline, and CTA from the Mood Board (Intentional Internet pack). Do not invent a competing Product Hunt slogan on the day. Campaign lines live on /mood-board; SOP 31 is how you use it.',
            href: '/mood-board',
      ...
      steps: [
        {
          ...
          text: 'Run this checklist on marketing campaigns, ads, landing pages, newsletters, and PR visuals before spend or publish. Campaign language should start on the Mood Board (SOP 31), then this brand check.',
          href: '/mood-board',
          hrefLabel: 'Mood Board',
        },
        {
        ...
        {
          id: 'bg-when-merch',
          label: 'Run it on merch and mood boards before you list on Printify',
          doneWhen: 'Run it on merch and mood boards before you list on Printify.',
          text: 'Run it on merch and mood boards before you list on Printify. Brand-check the mock before the community can buy it.',
          href: '/sops/merch',
...
export const MERCH_SOP = playbook({
  ...
  owner: 'Marketing Lead',
  format: 'checklist',
  who: 'Anyone designing Kahana merch for the Printify store, or a custom piece for a named creator collab',
  when: 'On an ongoing mood board, then before each catalog listing. Purchase custom merch only when a creator collab needs it.',
  description:
    'Design on-brand Kahana merch in Canva, brand-check it, and list it on Printify so community members can buy. Kahana earns from those sales. Printify prints and ships. Buy custom merch only to facilitate a named creator collaboration.',
  keywords: [
    'merch',
    'printify',
    'canva',
  ...
  notes: [
    'The default job is create on-brand merch and make it available on Printify. Community members buy there. Kahana earns. Printify fulfills. Do not stock a warehouse or run team/customer/club giveaway orders as this SOP.',
    'Selective exception: design custom merch and purchase it to facilitate a named creator collaboration. That is a buy for that collab, not a restock.',
  ...
  sections: [
    {
      ...
      intro: 'Ideas land all year. Capture them on a living board so listings are pulled from a pile, not invented the week of.',
      steps: [
        {
          id: 'merch-board-live',
        ...
        {
          id: 'merch-board-lock',
          label: 'Lock a listing brief before you design the SKU',
          doneWhen: 'Lock a listing brief before you design: SKU, colorway, must-include marks, off-limits, and price.',
          text: 'Lock a listing brief before you design: SKU, colorway, must-include marks, off-limits, and price so Kahana earns. Do not lock a bulk quantity or in-hand date. Catalog merch is print-on-demand.',
        },
      ],
    },
    {
      ...
      intro: 'On-brand first. A listing that fails SOP 6 does not go on Printify.',
      steps: [
        {
          id: 'merch-canva',
    ...
    {
      id: 'printify',
      title: 'List on Printify so the community can buy',
      intro: 'Printify is the store. Community members buy. Kahana earns. Printify prints and ships. We do not take Slack orders and fulfill them ourselves.',
      steps: [
        {
          id: 'merch-printify-catalog',
          label: 'Pick the product from Printify’s catalog',
        ...
        },
        {
          ...
          label: 'Upload the Canva export and check print size on the SKU',
          doneWhen: 'Upload the Canva export, generate mocks, and sanity-check print size on the actual SKU.',
        ...
        },
        {
          ...
          label: 'Share the Printify store link where the community will find it',
          doneWhen: 'Share the Printify store or product link in the places community members already look.',
          text: 'Share the Printify store or product link in clubs, hubs, newsletter, and official social (SOP 8). Point people to buy on Printify. Do not collect sizes and addresses in Slack to order for them.',
          href: '/sops/official-social-media',
          hrefLabel: 'SOP 8: Official Social Media',
        },
        {
          id: 'merch-photo',
          label: 'Photograph the listed piece for social and the campaign folder',
          doneWhen: 'Photograph the listed piece (or a sample of that SKU) for LinkedIn, Instagram, and the campaign folder.',
          text: 'Photograph the listed piece (or a sample of that SKU) for LinkedIn, Instagram, and the campaign folder so the Printify link has a real visual. People wearing it beat flat mocks. File the photos next to the Canva source. Official-account posts go through SOP 8.',
          href: '/sops/official-social-media',
          hrefLabel: 'SOP 8: Official Social Media',
        },
      ],
    ...
    {
      id: 'collab-custom',
      title: 'Custom merch for creator collabs (selective purchase)',
      intro: 'Most merch stays on the Printify store. Buy custom merch only when it facilitates a named creator collaboration.',
      steps: [
        {
          id: 'merch-collab-named',
          label: 'Name the creator collab before you buy custom merch',
          doneWhen: 'Name the creator collab and why custom merch is worth buying for that person.',
          text: 'Name the creator collab and why custom merch is worth buying for that person. This is not a default giveaway, team kit, or club restock. If there is no named collab, list on Printify instead.',
          href: '/sops/creator-outreach',
          hrefLabel: 'SOP 16: Creator Outreach',
        },
        {
          id: 'merch-collab-design',
          label: 'Design the custom piece on brand, with the creator’s rights',
          doneWhen: 'Design the custom piece in Canva, run SOP 6, and confirm written rights if it uses the creator’s marks.',
          text: 'Design the custom piece in Canva. Run SOP 6. If it uses the creator’s name, face, or marks, get written rights first. Keep it Kahana-on-brand. Do not invent a one-off that would fail the catalog bar.',
          href: '/sops/brand-guidelines',
          hrefLabel: 'SOP 6: Brand Guidelines',
        },
        {
          id: 'merch-collab-buy',
          label: 'Purchase only the units needed for that collab',
          doneWhen: 'Purchase only the units needed for that named collab (Printify order or the same catalog SKU).',
          text: 'Purchase only the units needed for that named collab. Use Printify. Do not bulk-order for the team, customers, or clubs “while we are at it.”',
        },
        {
          id: 'merch-collab-send',
          label: 'Send the custom merch to the named creator',
          doneWhen: 'Send the custom merch to the named creator and log it on the collab row.',
          text: 'Send the custom merch to the named creator. Log the send on the creator database row (SOP 16 / SOP 17). Do not use merch to inflate a club’s story.',
  ...
  doneWhen: [
    'The design lived on the merch mood board, was made in Canva, passed SOP 6, and was legally cleared.',
    'Catalog merch is live on Printify. Community members can buy it. Kahana earns. Printify fulfills.',
    'We did not stock a warehouse or run a team/customer/club giveaway order as this SOP.',
    'If custom merch was purchased, it was for a named creator collab only, and the send is logged.',
  ],
})
  ...
  sections: [
    ...
    },
    {
      ...
      steps: [
        ...
        {
          id: 'social-mood-board',
          label: 'Open the Mood Board before you draft the caption',
          doneWhen: 'Open the Mood Board before you draft the caption. Quote a locked campaign lane; do not invent a competing slogan.',
          text: 'Open the Mood Board before you draft the caption. Quote a locked campaign lane (The Feed Ends Here, Build a World, Someone Left You a Path, Five Sparks). For LinkedIn, start from the Channel archive examples (company vs Adam, five beats). SOP 31 is how you use the board.',
          href: '/mood-board#channel-archive',
          hrefLabel: 'Mood Board — channel archive',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      steps: [
        ...
        },
        {
          ...
          text: 'Watch a short Kahana example before your first recording so the pacing is clear: product on screen, tight cuts, demo not a slide deck. That walkthrough is the bar for a quick feature video.',
          href: FEATURE_VIDEO_EXAMPLE_URL,
          hrefLabel: 'Kahana feature video example',
        },
        {
          id: 'yt-capture',
