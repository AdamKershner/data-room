  ...
  sections: [
    ...
    },
    {
      ...
      steps: [
        ...
        {
          id: 'bg-quality',
          text: 'If the piece fails Level A (accurate product, no PII, working links, Kahana spelled correctly), it does not ship even if it looks on-brand.',
        },
      ],
    },
    {
  ...
  sections: [
    ...
    },
    {
      ...
      steps: [
        ...
        {
          id: 'pt-keys',
          text: 'If the test found committed or leaked keys, rotate first (Firebase, GitHub, Mixpanel, or whatever leaked), then come back to this report. Do not paste the old key into Slack.',
        },
      ],
    },
    {
  ...
  sections: [
    {
      ...
      steps: [
        ...
        {
          id: 'ct-tell',
          text: 'Tell the Engineering Lead and Adam the same day. Then contain (lock the account, rotate the key, take the surface offline if that is the instruction). Do not paste the old secret into Slack.',
        },
      ],
    },
    {
