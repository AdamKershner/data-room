/** Conversation-guide overrides keyed by platform id. */
...
export const BATTLECARD_OVERRIDES = {
  ...
  storygraph: {
    ...
    whenTheyWin:
      'Someone only wants Amazon-free tracking, mood filters, and reading analytics.',
    landmines:
  ...
  bookclubs: {
    ...
    proofPoints:
      'Club playbooks · wishlist → acquire · complementary to Discord-style ops.',
  },
  librarything: {
    kahanaOneLiner:
    ...
    whenTheyWin:
      'Someone needs serious cataloging, academic/obscure coverage, or LibraryThing for Libraries.',
    landmines:
    ...
    proofPoints:
      'Book Club playbook · wishlist · Aura.',
  },
  literal: {
    kahanaOneLiner:
    ...
    whenTheyWin:
      'Someone wants lightweight social reading and clubs without a full library product.',
    landmines:
    ...
    switchReason:
      'N/A — love both.',
    proofPoints:
      'Same rhyme as Fable · Book Club playbook · Aura.',
  },
  bookbrowse: {
    kahanaOneLiner:
