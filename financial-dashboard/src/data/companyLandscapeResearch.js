...
export const COMPANY_LANDSCAPE_RESEARCH = {
  ...
  guild: {
    tagline:
      'Professional messaging and community app — reviewers describe it as a messaging app for professionals with better content and connection quality than typical social platforms.',
    scaleFacts: [
      'Positioned as a professional messaging and community app focused on high-quality content and connections.',
    ],
    benefits: [
      {
        title: 'Professional focus',
        detail:
          'Designed for professionals rather than casual chat — better signal-to-noise than typical social networks.',
      },
      {
        title: 'Quality of connections',
        detail:
          'Reviews praise content and connection quality vs Facebook and similar platforms.',
      },
    ],
    weaknesses: [
      {
        title: 'Limited scale and ecosystem',
        detail:
          'Smaller user base; less known; fewer integrations than Slack or Discord.',
      },
      {
        title: 'Potential feature limitations',
        detail:
          'Less feature-rich than dedicated community platforms — more a niche professional messaging app.',
      },
    ],
    sources: ['https://www.g2.com/products/guild-guild/reviews'],
  },

  'facebook-groups': {
    tagline:
      'Spaces for people to connect with others who share their interests — free, familiar group communities inside Facebook.',
    scaleFacts: [
      'Hundreds of millions of groups globally; widely used for hobby, local, and interest-based communities.',
    ],
    benefits: [
      {
        title: 'Free and familiar',
        detail:
          'Most users already have Facebook; groups are easy to create and join.',
      },
      {
        title: 'Basic analytics',
        detail:
          'Insights on member activity, post engagement, and growth.',
      },
      {
        title: 'Good native mobile apps',
        detail:
          'Strong mobile presence; notifications and browsing integrated into the Facebook app.',
      },
    ],
    weaknesses: [
      {
        ...
        detail:
          'Group content is shaped by Facebook’s algorithm — posts can be buried or shown unpredictably.',
      },
      {
        title: 'Limited features and structure',
        detail:
          'Lacks advanced community tools vs dedicated platforms; discussions can get cluttered.',
      },
      {
        title: 'Too many distractions',
        detail:
          'Groups live inside Facebook’s feed — ads, notifications, and unrelated content compete for attention.',
      },
      {
        title: 'Poor notification systems',
        detail:
          'Notifications can be inconsistent or overwhelming; important posts are easily missed.',
      },
      {
        title: 'Privacy and ownership issues',
        detail:
          'Subject to Facebook’s rules; limited branding; weak ownership; not easily searchable externally.',
      },
    ],
    sources: [
  ...
  signal: {
    tagline:
      'A messaging app for simple, private communication — end-to-end encryption to keep conversations secure.',
    scaleFacts: [
      'Tens of millions of users globally; widely adopted by privacy-conscious individuals and activists.',
    ],
    benefits: [
      {
        title: 'Strong privacy and security',
        detail:
          'E2E encryption by default; minimal data collection; open-source client and server code.',
      },
      {
        title: 'Simple, clean UX',
        detail:
          'Focused on messaging and calls; no ads; limited distractions.',
      },
    ],
    weaknesses: [
      {
        title: 'Limited community features',
        detail:
          'Group chats only — no advanced spaces, courses, or events.',
      },
      {
        title: 'Smaller user base vs WhatsApp/Telegram',
        detail:
          'Harder to build large communities; not everyone has Signal installed.',
      },
    ],
  ...
  groupme: {
    tagline:
      '“GroupMe is a free, simple way to stay connected with friends, family, teams, roommates and more.”',
    scaleFacts: [
      'Popular in some markets for casual group chat; owned by Microsoft.',
    ],
    benefits: [
      {
        title: 'Simple, free group messaging',
        detail:
          'Easy group setup; SMS fallback for some users; no complex features required.',
      },
    ],
    weaknesses: [
      {
        title: 'Outdated UX and limited features',
        detail:
          'Fewer features than modern messengers; no advanced community tools or integrations.',
      },
      {
        title: 'Low adoption vs WhatsApp/Discord',
        detail:
          'Much lower usage; not serious competition beyond casual groups.',
      },
    ],
    sources: ['https://groupme.com/'],
  },
