...
const EXTRA_SEARCH_ENTRIES = [
  ...
  },
  {
    ...
    description:
      'Named revenue cases for Growth SaaS, marketplace take rate, and Enterprise focus theses.',
    keywords: [
      'pro forma',
      'revenue',
      'projections',
    ...
    nlHints: [
      'revenue projections',
      'pro forma cases',
      'what if we focus on enterprise',
      'saas vs marketplace revenue',
    ],
  },
  {
    path: '/battlecards',
    ...
    description:
      'Conversation guides: compare/contrast Kahana with peers and show how to use both — for prospects and new team members.',
    keywords: [
      'battlecards',
      'compare',
      'contrast',
    ...
    nlHints: [
      'how do we use kahana with instagram',
      'how do we compare to substack',
      'kahana vs netflix',
      'use both platforms',
    ],
  },
  {
    ...
    businessFunction: 'Marketing',
    description:
      'Club-centric fragment map — market pie, GTM phases (ebooks/courses/YouTube video groups first), competitors, capture ceilings.',
    keywords: [
      'fragment',
      'capture',
      'map',
    ...
    nlHints: [
      'what if we take 10% of substack',
      'gtm sequence',
      'youtube video groups',
      'should we attack goodreads or medium first',
      'fragment map',
      'fragment capture',
    ],
  },
