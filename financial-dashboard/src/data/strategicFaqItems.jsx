...
export const FAQ_ITEMS = [
  ...
  <>
    <p>The biggest issue: we didn&apos;t have a Chromium enterprise version of Oasis to demo or give Julian to test. Culture Amp is ready to invest, but we don&apos;t have the product ready. We&apos;ve assigned <strong>Kaushik, Revanth, Atharva, Ruturaj, and Mohammed</strong> to <Link to="/archive/oasis-sprints">Sprint 17</Link> (Oasis Chromium Enterprise Browser with Okta integration).</p>
