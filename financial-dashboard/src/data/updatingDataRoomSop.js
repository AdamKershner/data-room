  ...
  sections: [
    {
      ...
      steps: [
        ...
        },
        {
          ...
          text: 'Open /sops and find the SOP you will add or change. New SOPs take the next number after the last gallery card (29 is this SOP; the next new one is 30). Do not reuse a retired id.',
          href: '/sops',
    ...
    },
    {
      ...
      steps: [
        ...
        },
        {
          ...
          text: 'Register it in sopContent.js: import the SOP and aliases, add { ...YOUR_SOP, number: N } to SOPS_RAW, set SOP_READY_THROUGH to N when it is ready for review, add SOP_SCHEDULE (cadence and/or trigger), and include the aliases in resolveSopId. The next new SOP after this one is 30.',
          href: '/sops',
          hrefLabel: 'SOP gallery',
        },
        {
