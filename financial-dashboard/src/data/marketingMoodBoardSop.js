  ...
  sections: [
    ...
    },
    {
      ...
      steps: [
        ...
        {
          id: 'mmb-linkedin-examples',
          label: 'For LinkedIn, start from the Channel archive examples, not a blank caption',
          minutes: 15,
          doneWhen: 'For LinkedIn, start from the Channel archive: five beats, company page vs Adam’s personal page. Match the job of the beat. Do not mash product gifts into beat 1.',
          text: 'For LinkedIn, start from the Channel archive on the Mood Board. Five beats: the world changed, the Infinite Feed, Promised Land, magical gifts, evidence. Company is sourced and institutional. Adam is first-person. Official company posts still go through SOP 8. Do not paste Adam’s personal voice onto the company page.',
      ...
      steps: [
        {
          ...
          text: 'Add the spark to the Mood Board backlog: writings, images, videos, ads, or a Channel archive draft (channel, voice, beat, body). When a Canva, Figma, or Google Doc exists, put the URL in the Workspace slots on the page. Do not leave the only copy in a private chat.',
          href: '/mood-board',
          hrefLabel: 'Mood Board',
        },
      ],
