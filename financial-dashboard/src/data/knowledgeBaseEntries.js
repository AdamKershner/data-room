...
export const KNOWLEDGE_BASE_ENTRIES = [
  ...
  },
  {
    ...
    category: 'Finance',
    description:
      'Revenue projections by focus case — Growth SaaS, 5% take rate, Enterprise, and feature attach assumptions.',
    keywords: [
      'pro forma',
      'revenue',
      'projections',
  ...
  },
  {
    ...
    category: 'Marketing',
    description:
      'Conversation guides comparing Kahana with peer platforms and showing how to use both (e.g. Instagram for entertainment, Kahana for longer-form learning).',
    keywords: [
      'battlecards',
      'compare',
      'contrast',
  ...
  },
  {
    ...
    category: 'Marketing',
    description:
      'Strategic map of content fragments sized by market $ — occupy competitor provinces and model 10–100% capture for attack pathways.',
    keywords: [
      'fragment',
      'capture',
      'map',
