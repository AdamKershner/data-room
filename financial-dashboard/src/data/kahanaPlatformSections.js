...
import { KAHANA_LIBRARY_URL, KAHANA_SITE_URL } from '../constants/kahanaSite'
...
export const KAHANA_PLATFORM_PAGE = {
  ...
  subtitle:
    'A digital library with Aura — Clubs, curated content, and community-governed discovery at kahana.io.',
  northStar:
...
export const VISION_FEELING = {
  ...
  product:
    'Kahana is the digital library with Aura: a place you can always go to fall into focus, feel productive, and be surrounded by other learners. We are building the room people deserve for thinking, learning, and becoming better.',
  stakes:
