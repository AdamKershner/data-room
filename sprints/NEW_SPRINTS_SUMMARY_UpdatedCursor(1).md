...
| Sprint | Priority | Story Points | Parallel Track | Primary Files (conflict surface) |
|--------|----------|--------------|----------------|----------------------------------|
| Sprint 8 | CRITICAL | 18 | Engine | `assistant.ts`, `proxyClient.ts`, `awsSignedFetch.ts` |
| Sprint 9 | HIGH | 29 | Hubs + Tabs/Windows + Onboarding | `hubs.ts`, `commands.ts`, browser first-run UI, `browser/branding/**` |
| Sprint 10 | HIGH | 21 | Auth/Subscription | `assistant.ui.js`, `services/supabase.ts`, `services/subscription.ts` |
| Sprint 11 | MEDIUM-HIGH | 10 | Onboarding/Branding | `assistant.ui.js`, `browser/branding/**`, first-run UI |
| Sprint 12 | MEDIUM | 5 | Search | `search.ts`, `assistant.ts` |
| Sprint 13 | MEDIUM | 5 | Search | `search.ts`, `hubs.ts` |
| Sprint 14 | MEDIUM | 8 | Tab Organization | `assistant.ts`, `hubs.ts`, `commands.ts` |
| Sprint 15 | MEDIUM | 3 | Tab Groups | `hubs.ts`, `commands.ts` |
| Sprint 16 | MEDIUM | 5 | Firefox Integration | `commands.ts`, Firefox splitview API |
| Sprint 17 | MEDIUM | 8 | Chat History | `chatHistory.ts`, `assistant.ui.js`, `services/supabase.ts` |
| Sprint 18 | MEDIUM | 8 | Summarization | `summarize.ts`, `assistant.ts` |
| Sprint 19 | MEDIUM | 5 | Tagging | `tags.ts`, `hubs.ts`, `assistant.ui.js` |
| Sprint 20 | MEDIUM | 8 | Updates | Update system, `assistant.ui.js` |
| Sprint 21 | CRITICAL | 5 | Model Migration | `proxyClient.ts`, `awsSignedFetch.ts`, `services/subscription.ts` |
| Sprint 22 | MEDIUM | 6 | UI/Bug Fixes | `assistant.ts`, `commands.ts`, `assistant.ui.js` |
| **Total** | - | **133** | - | - |
